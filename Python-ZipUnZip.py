...
def CreateWidgets():
    selectlabel = Label(root, text="FILES TO ZIP : ", bg="azure4")
    ...
    zipNamelabel = Label(root, text="ZIPPED LOCATION : ", bg="azure4")
    ...
    unzipFilelabel = Label(root, text="FILE TO UNZIP : ", bg="azure4")
    ...
    unzipFileNamelabel = Label(root, text="UNZIPPED LOCATION: ", bg="azure4")
